...
public class ShootForward_TopDown : ShootAllDirection
{
    [Header("Top Down Shoot Forward. This attack shoots a projectile in the direction the character is facing. It is designed for top down games.")]
